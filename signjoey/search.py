...
def beam_search(
    ...
    for step in range(max_output_length):
        ...
        # print(type(topk_beam_index), topk_beam_index)
        ...
        # print(type(select_indices), select_indices)
